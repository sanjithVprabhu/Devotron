// Encrypt/decrypt per-tenant API credentials (AiSensy project_api_pwd, webhook secret).
// AES-256-GCM keyed by TENANT_SECRET_KEY_B64 (32 raw bytes, base64-encoded).
// Never log decrypted values; only call decrypt at the boundary where the
// secret is about to be used in an outbound request.
